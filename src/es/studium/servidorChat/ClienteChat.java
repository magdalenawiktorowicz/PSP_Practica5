...
public class ClienteChat extends JFrame implements ActionListener
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		System.setProperty("javax.net.ssl.trustStore", "ClientTrustStore.jks"); // el nombre del fichero del almacén
		System.setProperty("javax.net.ssl.trustStorePassword", "Studium2024"); // la contraseña
